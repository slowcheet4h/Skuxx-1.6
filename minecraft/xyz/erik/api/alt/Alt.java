...
/**
 * Created by Karanlik on 10/20/2017.
 */
public final class Alt
    ...
    public Alt(FontRenderer p_i1032_1_, int p_i1032_2_, int p_i1032_3_, int p_i1032_4_, int p_i1032_5_) {
    ...
    public void drawTextBox() {
        if (func_146176_q()) {
            if (func_146181_i()) {
                if (DrawBackGround == true) {
                    drawRect(this.field_146209_f - 1, this.field_146210_g - 1, this.field_146209_f +
                            this.field_146218_h + 1, this.field_146210_g + this.field_146219_i +
                            1, -6250336);
                    ...
                    drawRect(this.field_146209_f - 1, this.field_146210_g + 20, this.field_146209_f + this.field_146218_h + 1, this.field_146210_g + this.field_146219_i + 1, -6250336);
                }
            }
            ...
            String var4 = this.field_146211_a.trimStringToWidth(
                    this.field_146216_j.substring(this.field_146225_q), func_146200_o());
            boolean var5 = (var2 >= 0) && (var2 <= var4.length());
            boolean var6 = (this.field_146213_o) && (this.field_146214_l / 6 % 2 == 0) &&
                    (var5);
            int var7 = this.field_146215_m ? this.field_146209_f + 4 :
                    this.field_146209_f;
            int var8 = this.field_146215_m ? this.field_146210_g +
                    (this.field_146219_i - 8) / 2 : this.field_146210_g;
            int var9 = var7;
            if (var3 > var4.length()) {
                var3 = var4.length();
            }
            if (var4.length() > 0) {
                ...
                var9 = this.field_146211_a.drawString(
                        var10.replaceAll(".", "*"), var7, var8, var1);
            }
            ...
            if ((var4.length() > 0) && (var5) && (var2 < var4.length())) {
                this.field_146211_a.drawString(var4.substring(var2)
                        .replaceAll(".", "*"), var9, var8, var1);
            }
            if (var6) {
                if (var13) {
            ...
            if (var3 != var2) {
                int var12 = var7 +
                        this.field_146211_a.getStringWidth(var4.substring(0, var3)
                                .replaceAll(".", "*"));
    ...
    public void func_146175_b(int p_146175_1_) {
        if (this.field_146216_j.length() != 0) {
            if (this.field_146223_s != this.field_146224_r) {
                ...
                int var3 = var2 ? this.field_146224_r + p_146175_1_ :
                        this.field_146224_r;
                int var4 = var2 ? this.field_146224_r : this.field_146224_r +
                        p_146175_1_;
                String var5 = "";
                if (var3 >= 0) {
    ...
    public void func_146191_b(String p_146191_1_) {
        ...
        int var4 = this.field_146224_r < this.field_146223_s ? this.field_146224_r :
                this.field_146223_s;
        int var5 = this.field_146224_r < this.field_146223_s ? this.field_146223_s :
                this.field_146224_r;
        int var6 = this.field_146217_k - this.field_146216_j.length() - (
                var4 - this.field_146223_s);
        if (this.field_146216_j.length() > 0) {
            ...
            if (var5) {
                do {
                    var4--;
                        ...
                        (this.field_146216_j.charAt(var4 - 1) == ' '));
                do {
                    var4--;
                    if (var4 <= 0) {
                        break;
    ...
    public String func_146207_c() {
        int var1 = this.field_146224_r < this.field_146223_s ? this.field_146224_r :
                this.field_146223_s;
        int var2 = this.field_146224_r < this.field_146223_s ? this.field_146223_s :
                this.field_146224_r;
    ...
    public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_) {
        ...
        if ((this.field_146213_o) && (p_146192_3_ == 0)) {
            ...
            String var6 = this.field_146211_a.trimStringToWidth(
                    this.field_146216_j.substring(this.field_146225_q), func_146200_o());
