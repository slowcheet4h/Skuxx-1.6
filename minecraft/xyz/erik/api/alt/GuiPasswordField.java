        ...
        extends Gui
{
    ...
    {
        boolean var4 = (p_146192_1_ >= this.xPosition) && (p_146192_1_ < this.xPosition + this.width) &&
        ...
        if ((this.isFocused) && (var4) && (p_146192_3_ == 0))
        {
            ...
            String var6 = this.fontRendererInstance.trimStringToWidth(this.text.substring(this.lineScrollOffset),
                    getWidth());
            setCursorPosition(
                    this.fontRendererInstance.trimStringToWidth(var6, var5).length() + this.lineScrollOffset);
        }
    }
    ...
    public void drawTextBox()
    {
        if (getVisible())
        {
            ...
            String var4 = this.fontRendererInstance.trimStringToWidth(this.text.substring(this.lineScrollOffset),
                    getWidth());
            ...
            if (var4.length() > 0)
            {
                ...
                var9 = Minecraft.getMinecraft().fontRendererObj
                        .drawString(var10.replaceAll(this.textVisible ? "" : "(?s).", "*"), var7, var8, var1);
            }
            boolean var11 = (this.cursorPosition < this.text.length()) || (
                    this.text.length() >= getMaxStringLength());
            int var12 = var9;
            if (!var5)
            {
            ...
            if ((var4.length() > 0) && (var5) && (var2 < var4.length())) {
                var9 = Minecraft.getMinecraft().fontRendererObj.drawString(
                        var4.substring(var2).replaceAll(this.textVisible ? "" : "(?s).", "*"), var9, var8, var1);
            }
            if (var6) {
                if (var11) {
                    Gui.drawRect(var12, var8 - 1, var12 + 1,
            ...
            if (var3 != var2)
            {
                int var13 = var7 + Minecraft.getMinecraft().fontRendererObj
                        .getStringWidth(var4.substring(0, var3).replaceAll(this.textVisible ? "" : "(?s).", "*"));
                drawCursorVertical(var12, var8 - 1, var13 - 1,
