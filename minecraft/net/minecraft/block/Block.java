...
public class Block
{
    ...
    public void addCollisionBoxesToList(World worldIn, BlockPos pos, IBlockState state, AxisAlignedBB mask, List list, Entity collidingEntity)
    {
        ...
        BlockBoundingBoxEvent blockBoundingBoxEvent = new BlockBoundingBoxEvent(this, var7, pos, state);
        blockBoundingBoxEvent.fire();
        if (blockBoundingBoxEvent.isCancelled()) {
            return;
        }
        if (var7 != blockBoundingBoxEvent.getBoundingBox()) {
            var7 = blockBoundingBoxEvent.getBoundingBox();
        }
