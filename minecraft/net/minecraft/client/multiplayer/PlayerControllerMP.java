...
import xyz.erik.skuxx.event.events.BlockBreaking;
import xyz.erik.skuxx.event.events.EventAttack;
import xyz.erik.skuxx.event.events.EventReach;
...
public class PlayerControllerMP
{
    ...
    public BlockPos field_178895_c = new BlockPos(-1, -1, -1);
    ...
    public boolean func_180511_b(BlockPos p_180511_1_, EnumFacing p_180511_2_)
    {
        ...
        else
        {
            ...
            {
                BlockBreaking blockBreaking = new BlockBreaking(Helper.mc().theWorld.getBlockState(p_180511_1_).getBlock(),p_180511_1_, p_180511_2_, Event.Motion.BEFORE);
                blockBreaking.fire();
                if (blockBreaking.isCancelled()) return false;
    ...
    public boolean breakLikeTeo(BlockPos p_180511_1_, EnumFacing p_180511_2_)
    {
        Block var3;
    ...
    public ItemStack windowClickNoPacket(int windowId, int slotId, int mouseButtonClicked, int p_78753_4_, EntityPlayer playerIn)
    {
    ...
    {
        BlockBreaking blockBreaking = new BlockBreaking(Helper.mc().theWorld.getBlockState(p_180512_1_).getBlock(), p_180512_1_,p_180512_2_, Event.Motion.BEFORE);
        blockBreaking.fire();
        if (blockBreaking.isCancelled()) return false;
    ...
    {
        EventReach eventReach = new EventReach(this.currentGameType.isCreative() ? 5.0F : 4.5F);
        eventReach.fire();
        return eventReach.getReach();
    }
    ...
    public boolean  func_178890_a(EntityPlayerSP p_178890_1_, WorldClient p_178890_2_, ItemStack p_178890_3_, BlockPos p_178890_4_, EnumFacing p_178890_5_, Vec3 p_178890_6_) {
        syncCurrentPlayItem();
        float var7 = (float) (p_178890_6_.xCoord - p_178890_4_.getX());
        float var8 = (float) (p_178890_6_.yCoord - p_178890_4_.getY());
        float var9 = (float) (p_178890_6_.zCoord - p_178890_4_.getZ());
        boolean var10 = false;
    ...
    public Player func_178892_a(World worldIn, StatFileWriter p_178892_2_)
    {
        return new Player(this.mc, worldIn, this.netClientHandler, p_178892_2_);
    }
