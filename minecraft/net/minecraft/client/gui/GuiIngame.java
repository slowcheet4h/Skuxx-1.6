...
public class GuiIngame extends Gui
{
    ...
    public void func_175180_a(float p_175180_1_)
    {
        ...
        if (!mc.gameSettings.showDebugInfo) {
            GL11.glPushMatrix();
            GlStateManager.enableAlpha();
            EventRender eventRender = new EventRender(var2.getScaledWidth(), var2.getScaledHeight(), -1);
            eventRender.fire();
            GlStateManager.disableAlpha();
            GL11.glPopMatrix();
        }
    ...
    private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        int var231 = p_180475_2_.getScaledHeight() / 2 + var221 / 3 + 100;
        byte var241 = 3;
        ...
        while (var12.hasNext())
        {
            ...
            drawRect(var25 - 2, var18, var19, var18 + this.func_175179_f().FONT_HEIGHT, 0x90404040);
            ...
            if (var11 == var21.size())
            {
                ...
                drawRect(var25 - 2, var18 - this.func_175179_f().FONT_HEIGHT - 1, var19, var18 - 1, 0x80404040);
                drawRect(var25 - 2, var18 - 1, var19, var18, 0x80404040);
    ...
    private void func_180477_d(ScaledResolution p_180477_1_)
    {
        if (this.mc.func_175606_aa() instanceof EntityPlayer)
        {
           ...
           // if (var2.hurtTime > 4)      drawGradientRect(0,0,p_180477_1_.getScaledWidth(),p_180477_1_.getScaledHeight(),0x00c91900,0x30c91900);
