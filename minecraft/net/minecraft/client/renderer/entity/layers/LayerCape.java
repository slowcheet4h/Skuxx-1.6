...
public class LayerCape implements LayerRenderer
{
    ...
    public void doRenderLayer(AbstractClientPlayer p_177166_1_, float p_177166_2_, float p_177166_3_, float p_177166_4_, float p_177166_5_, float p_177166_6_, float p_177166_7_, float p_177166_8_)
    {
        ...
        if (((p_177166_1_ instanceof EntityPlayerSP && Skuxx.getInstance().getSkuxxPlayer().getCape() != null) || (Skuxx.getSkuxxUser(p_177166_1_.getName()) != null && Skuxx.getSkuxxUser(p_177166_1_.getName()).getCape() != null)) && !p_177166_1_.isInvisible()) {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
          //  System.out.println(p_177166_1_.getName());
            if (p_177166_1_ instanceof EntityPlayerSP) {
                this.playerRenderer.bindTexture(
                        new ResourceLocation("skuxx/capes/" + Skuxx.getInstance().getSkuxxPlayer().getCape().fileName));
            } else {
                this.playerRenderer.bindTexture(
                        new ResourceLocation("skuxx/capes/" + Skuxx.getSkuxxUser(p_177166_1_.getName()).getCape().fileName));
            }

            GlStateManager.pushMatrix();
            GlStateManager.translate(0.0F, p_177166_1_.isChild() ? 0.6F : 0, p_177166_1_.isChild() ? 0.1 : 0.125F);
            if (p_177166_1_.isChild()) {
                GlStateManager.scale(0.7F,0.7F,0.7F);
            }
            double var9 = p_177166_1_.field_71091_bM + (p_177166_1_.field_71094_bP - p_177166_1_.field_71091_bM) * p_177166_4_ - (p_177166_1_.prevPosX + (p_177166_1_.posX - p_177166_1_.prevPosX) * p_177166_4_);
            double var11 = p_177166_1_.field_71096_bN + (p_177166_1_.field_71095_bQ - p_177166_1_.field_71096_bN) * p_177166_4_ - (p_177166_1_.prevPosY + (p_177166_1_.posY - p_177166_1_.prevPosY) * p_177166_4_);
            double var13 = p_177166_1_.field_71097_bO + (p_177166_1_.field_71085_bR - p_177166_1_.field_71097_bO) * p_177166_4_ - (p_177166_1_.prevPosZ + (p_177166_1_.posZ - p_177166_1_.prevPosZ) * p_177166_4_);
        ...
        } else         if ((p_177166_1_.hasCape() && !p_177166_1_.isInvisible() && p_177166_1_.func_175148_a(EnumPlayerModelParts.CAPE) && p_177166_1_.getLocationCape() != null))
        {
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
