...
public class RenderPlayer extends RendererLivingEntity
{
    ...
    private void func_177137_d(AbstractClientPlayer p_177137_1_)
    {
        ...
        else
        {
            ...
            var2.heldItemLeft = 0;
            var2.aimedBow = false;
            var2.isSneak = p_177137_1_.isSneaking() ||(p_177137_1_ instanceof EntityPlayerSP && Skuxx.getInstance().getModManager().getMod("Sneakers").getState()) ;
    ...
    {
        boolean standartSleeping = p_77039_1_.isPlayerSleeping() && p_77039_1_.isEntityAlive();
        boolean me = p_77039_1_ instanceof EntityPlayerSP && Skuxx.getInstance().getSkuxxPlayer().isSleeping();
        boolean other = Skuxx.getSkuxxUser(p_77039_1_.getName()) != null && Skuxx.getSkuxxUser(p_77039_1_.getName()).isSleeping();

        if  (standartSleeping || me || other) {
    ...
    {
        boolean standartSleeping = p_180595_1_.isPlayerSleeping() && p_180595_1_.isEntityAlive();
        boolean me = p_180595_1_ instanceof EntityPlayerSP && Skuxx.getInstance().getSkuxxPlayer().isSleeping();
        boolean other = Skuxx.getSkuxxUser(p_180595_1_.getName()) != null && Skuxx.getSkuxxUser(p_180595_1_.getName()).isSleeping();
        if (standartSleeping || me || other) {
            GlStateManager.rotate(standartSleeping ? p_180595_1_.rotationYaw : 90, 0.0F, 1.0F, 0.0F);
            GlStateManager.rotate(standartSleeping ? p_180595_1_.rotationYaw : 90, 0.0F, 0.0F, 1.0F);
