...
import xyz.erik.skuxx.event.events.PassSpecialRender;
...
public abstract class RendererLivingEntity extends Render
{
    ...
    public void doRender(EntityLivingBase p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, new Object[] {p_76986_1_, this, Double.valueOf(p_76986_2_), Double.valueOf(p_76986_4_), Double.valueOf(p_76986_6_)}))
        {
            ...
            if (p_76986_1_ instanceof EntityPlayerSP) {
                RenderRiding riding = new RenderRiding(p_76986_1_.isRiding());
                riding.fire();
                this.mainModel.isRiding = riding.getRiding() || Skuxx.getInstance().getSkuxxPlayer().isRiding();
            } else {
                this.mainModel.isRiding = p_76986_1_.isRiding() || (p_76986_1_ instanceof EntityPlayer && Skuxx.getSkuxxUser(p_76986_1_.getName()) != null && Skuxx.getSkuxxUser(p_76986_1_.getName()).isRiding());
            }
    ...
    protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
        ...
        else
        {
            ...
            if (Helper.player().isUpsideDown() || var61 != null && (var61.equals("Dinnerbone") || var61.equals("Grumm")) && (!(p_77043_1_ instanceof EntityPlayer) || ((EntityPlayer)p_77043_1_).func_175148_a(EnumPlayerModelParts.CAPE)))
            {
    ...
    protected boolean canRenderName(EntityLivingBase targetEntity)
    {
        ...
        PassSpecialRender passSpecialRender = new PassSpecialRender();
        passSpecialRender.fire();
        if (passSpecialRender.isCancelled()) {
            return false;
        }
