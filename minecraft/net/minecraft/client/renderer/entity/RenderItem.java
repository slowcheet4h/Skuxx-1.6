...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    public void func_175049_a(ItemStack p_175049_1_, EntityLivingBase p_175049_2_, ItemCameraTransforms.TransformType p_175049_3_)
    {
        ...
        if (p_175049_2_ instanceof EntityPlayer)
        {
            ...
            }else if ((var6 instanceof ItemSword))
            {
                try
                {
                    if ((((EntityPlayer)p_175049_2_).getItemInUseCount() > 0) && (p_175049_2_.getHeldItem().getItemUseAction() == EnumAction.BLOCK))
                    {
                        GL11.glTranslatef(0.05F, p_175049_2_.isSneaking() ? 0.2F : 0.0F, -0.1F);
    ...
    public void memes(final ItemStack p_180450_1_, int p_180450_2_, int p_180450_3_)
    {
        if (p_180450_1_ != null)
        {
            this.zLevel += 50.0F;
            try
            {
                memes2(p_180450_1_, p_180450_2_, p_180450_3_);
            }
            catch (Throwable var7)
            {
                CrashReport var5 = CrashReport.makeCrashReport(var7, "Rendering item");
    ...
    public void memes2(ItemStack p_175042_1_, int p_175042_2_, int p_175042_3_)
    {
        IBakedModel var4 = this.itemModelMesher.getItemModel(p_175042_1_);
        GlStateManager.pushMatrix();
        this.field_175057_n.bindTexture(TextureMap.locationBlocksTexture);
        ...
        GlStateManager.blendFunc(770, 771);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        func_180452_a(p_175042_2_, p_175042_3_, var4.isAmbientOcclusionEnabled());
        func_175034_a(var4.getItemCameraTransforms().field_178354_e);
        supermeme(p_175042_1_, var4);
        GlStateManager.disableAlpha();
        GlStateManager.disableRescaleNormal();
        GlStateManager.disableLighting();
        GlStateManager.popMatrix();
    ...
    public void supermeme(ItemStack p_180454_1_, IBakedModel p_180454_2_)
    {
        GlStateManager.pushMatrix();
        GlStateManager.scale(0.5F, 0.5F, 0.5F);
        if (p_180454_2_.isBuiltInRenderer())
        ...
        {
            GlStateManager.translate(-0.5F, -0.5F, -0.5F);
            func_175036_a(p_180454_2_, p_180454_1_);

            p_180454_1_.hasEffect();
        }
        GlStateManager.popMatrix();
    }
    ...
    protected void applyTransform(ItemTransformVec3f transform)
    {
        ...
        {
            GlStateManager.translate(transform.field_178365_c.x + field_175055_b, transform.field_178365_c.y + field_175056_c, transform.field_178365_c.z + field_175053_d);
            GlStateManager.rotate(transform.field_178364_b.y + field_175054_e, 0.0F, 1.0F, 0.0F);
            GlStateManager.rotate(transform.field_178364_b.x + field_175051_f, 1.0F, 0.0F, 0.0F);
            GlStateManager.rotate(transform.field_178364_b.z + field_175052_g, 0.0F, 0.0F, 1.0F);
            GlStateManager.scale(transform.field_178363_d.x + field_175061_h, transform.field_178363_d.y + field_175062_i, transform.field_178363_d.z + field_175060_j);
        }
    }
    ...
    private void renderModel(IBakedModel model, int color, ItemStack stack)
    {
        ...
        {
            EnumFacing var9 = var6[var8];
            renderQuads(var5, model.func_177551_a(var9), color, stack);
        }
        renderQuads(var5, model.func_177550_a(), color, stack);
        var4.draw();
    }
    private void renderQuads(WorldRenderer renderer, List quads, int color, ItemStack stack)
    {
        ...
        BakedQuad var7;
        int var8;
        for (Iterator var6 = quads.iterator(); var6.hasNext(); renderQuad(renderer, var7, var8))
        {
            var7 = (BakedQuad)var6.next();
            var8 = color;
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition, String text)
    {
        if (stack != null)
        {
            ...
            if (stack.isItemDamaged())
            {
                ...
                int var10 = 255 - var7 << 16 | var7 << 8;
                int var11 = (255 - var7) / 4 << 16 | 0x3F00;
                drawRect(var9, xPosition + 2, yPosition + 13, 13, 2, 0);
                drawRect(var9, xPosition + 2, yPosition + 13, 12, 1, var11);
                drawRect(var9, xPosition + 2, yPosition + 13, var12, 1, var10);
                GlStateManager.enableBlend();
                GlStateManager.enableAlpha();
