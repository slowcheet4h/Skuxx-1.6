...
public class Main
{
    ...
    {
        return System.getProperty("user.home") + "/Skuxx";
    }

    public static void main(String[] p_main_0_)
    {
        String username = JOptionPane.showInputDialog("Kullanıcı adi giriniz: ");
        Skuxx.setUser(username);
        TrayIcon.addNotification("Logged to " + Skuxx.getUser(), "Skuxx");
        System.setProperty("" +
                "" +
