...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public boolean llololol;
    public boolean isChild() {
        return (Skuxx.getSkuxxUser(getName()) != null && Skuxx.getSkuxxUser(getName()).isChild()) || llololol || (this instanceof EntityPlayerSP && Skuxx.getInstance().getSkuxxPlayer().isChild());
    }
