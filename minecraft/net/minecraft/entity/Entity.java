...
public abstract class Entity implements ICommandSender
{
    ...
    public void setPosition(double[] position) {
        setPositionAndUpdate(position[0],position[1],position[2]);
    }
    /**
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            SafeWalkEvent safeWalkEvent = new SafeWalkEvent();safeWalkEvent.fire();
            if ((var19) ||(this instanceof EntityPlayerSP && safeWalkEvent.getSafeWalk()))
            {
                double var20;
            ...
            double stepHeight = stepEvent.getHeight();
            ...
            if ((this instanceof EntityPlayerSP)) {
                (new StepEvent(StepEvent.Time.AFTER)).fire();
            }
            this.worldObj.theProfiler.endSection();
            ...
            BobbingEvent bobbing = new BobbingEvent(false);
            bobbing.fire();
            this.onGround = (this.isCollidedVertically && var15 < 0.0D) || bobbing.isBobbing();
