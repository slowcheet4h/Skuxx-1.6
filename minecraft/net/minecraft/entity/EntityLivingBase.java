...
public abstract class EntityLivingBase extends Entity
{
    ...
    public boolean tempHit;
    /** Whether an arm swing is currently in progress. */
    public boolean isSwingInProgress;
    public int swingProgressInt;
    public int arrowHitTimer;
    private ErikTimer hTimer = new ErikTimer();
    ...
    public boolean isCanHurt(boolean next) {
        if (hurtTimer.delay(next ? 527 : 500)) {
            hurtTimer.reset();
            return true;
        }
        return false;
    ...
    public boolean hurttime() {
        if (hTimer.delay(527) || (this.hurtResistantTime == 0 && hTimer.delay(300))) {
            return true;
        }
        return false;
    }
    ...
    public int getHurt() {
        return (int) hTimer.getDifference();
    }
}
